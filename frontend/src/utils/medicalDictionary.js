...
const MEDICAL_DICTIONARY = {
  ...
  RPP: 'Rate Pressure Product (RPP) = Heart Rate × Systolic Blood Pressure. Measures myocardial oxygen consumption and workload.',
  FastingBS: 'Fasting Blood Sugar — Glucose level after an overnight fast; key indicator for metabolic assessment.',
  'Fasting Blood Sugar': 'Fasting Blood Sugar — Glucose level after an overnight fast; key indicator for metabolic assessment.',
  MaxHR: 'Maximum Heart Rate — Highest heart rate achieved during stress or clinical assessment.',
  'Max HR': 'Maximum Heart Rate — Highest heart rate achieved during stress or clinical assessment.',
  'Maximum Heart Rate': 'Maximum Heart Rate — Highest heart rate achieved during stress or clinical assessment.',
